   ...
   abstract class AbstractPatternsFactory 
    ...
    class CreationalPatternsFactorry : AbstractPatternsFactory
    {
        ...
        public override PatternDetails CreatePatternDetails()
        {
            ...
            creationalDetails.Patterns.Add(new AbstractFactoryPatternsFactorry().GetPatternDetails());
            creationalDetails.Patterns.Add(new BuilderPatternsFactorry().GetPatternDetails());
            creationalDetails.Patterns.Add(new PrototypePatternsFactorry().GetPatternDetails());
            creationalDetails.Patterns.Add(new SingletonPatternsFactorry().GetPatternDetails());
